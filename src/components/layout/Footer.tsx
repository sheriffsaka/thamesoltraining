...
export function Footer() {
  ...
  return (
    <footer className="bg-brand-surface/50 text-slate-400 pt-24 pb-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-brand-teal hover:text-white transition-all border border-white/5 shadow-sm">
                  <Icon size={16} />
                </a>
              ))}
            </div>
          ...
          <div>
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-white mb-8">Navigation</h4>
          ...
          <div>
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-white mb-8">Contact</h4>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-slate-600">
          ...
          <div className="flex gap-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-emerald-500/80">Secure Connection</span>
            </div>
          </div>
        </div>
      </div>
