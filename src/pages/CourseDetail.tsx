  ...
  return (
    <div className="bg-brand-dark min-h-screen pt-20">
      ...
      <section className="relative h-[500px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 text-slate-900">
          <motion.button 
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-slate-600 hover:text-brand-teal transition-colors mb-8 font-bold text-xs uppercase tracking-widest bg-white/80 backdrop-blur px-4 py-2 rounded-full border border-slate-200 shadow-sm"
          >
            <ArrowLeft size={16} />
            Back to Courses
          </motion.button>
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold max-w-4xl font-serif leading-tight shadow-white/20 select-none">{mockCourse.title}</h1>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
          ...
          <div className="lg:col-span-2 space-y-16">
            <motion.div
               ...
               viewport={{ once: true }}
            >
              <h2 className="text-xl font-bold text-slate-900 mb-8 font-serif flex items-center gap-4">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mockCourse.outcomes.map((outcome, i) => (
                  <div key={i} className="flex gap-4 p-5 rounded-2xl bg-white border border-slate-100 hover:border-brand-teal/20 transition-all group shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              <motion.div 
                 ...
                 whileInView={{ opacity: 1, x: 0 }}
                 viewport={{ once: true }}
                 className="bg-brand-surface rounded-[2.5rem] p-10 border border-slate-100 self-start shadow-xl space-y-8"
              >
                <div className="flex gap-6 items-center">
                  <div className="w-14 h-14 bg-white border border-slate-100 rounded-2xl flex items-center justify-center text-brand-teal shadow-sm">
                    <Award size={28} />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-500 uppercase tracking-widest text-[10px] mb-1.5">Certification</h4>
                    <p className="text-slate-900 font-bold leading-tight font-serif">{mockCourse.certification}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-500 uppercase tracking-widest text-[10px] mb-1.5">Accreditation</h4>
                    <p className="text-slate-900 font-bold leading-tight font-serif">Nationally Recognized (RQF)</p>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <aside className="space-y-8">
            <div className="sticky top-28 bg-white border border-slate-200 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 text-center">
                <div className="mb-10">
                  <div className="flex justify-center mb-6">
                    <div className="w-20 h-20 bg-brand-surface border border-slate-100 rounded-3xl flex items-center justify-center text-brand-teal">
                      <Clock size={36} />
                    </div>
                  </div>
                  <h3 className="text-sm font-bold text-slate-500 uppercase tracking-[0.2em] mb-2 text-center">Duration</h3>
                  <p className="text-3xl font-bold text-slate-900 font-serif">{mockCourse.duration}</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-xs text-slate-500 font-bold uppercase tracking-widest pt-6 border-t border-slate-100">
        ...
        {isApplying && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-slate-200"
            >
              {formStatus === 'success' ? (
                ...
                <div className="p-10 lg:p-14">
                  <div className="mb-10">
                    <h2 className="text-3xl font-bold text-slate-900 font-serif mb-2">Apply for Course</h2>
                    <p className="text-brand-teal font-bold text-xs uppercase tracking-widest">Submit your details to get started</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-5">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-14 pr-6 py-4.5 bg-slate-50 border border-slate-200 rounded-2xl focus:border-brand-teal outline-none text-slate-900 transition-all placeholder:text-slate-400"
                        />
                      </div>
                      <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          rows={4}
                          className="w-full pl-14 pr-6 py-4.5 bg-slate-50 border border-slate-200 rounded-2xl focus:border-brand-teal outline-none text-slate-900 transition-all placeholder:text-slate-400 resize-none"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-brand-teal text-white py-5 rounded-2xl font-bold text-lg hover:bg-brand-accent transition-all disabled:opacity-50 flex items-center justify-center gap-3"
                    >
